...
export default function ContactPrivacyConsent({ checked, onChange, error, ref }: Props) {
  return (
    <div className="my-3 flex items-start gap-3">
      ...
      <div>
        <label className="text-base leading-6 font-medium text-black md:text-lg" htmlFor="privacy">
